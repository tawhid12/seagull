					...
					<div class="card-body" id="result_show">
						<table style="width: 100%" id="companyDescript">
                            <tr style="text-align: center;">
                                <th colspan="2">
                                    <h4>Seagull Marine Engineers (Pvt) Ltd</h4>
                                    <p>
										Bay Esplanade" (3rd Floor), 164/B,        
										Sk. Mujib Road, Badamtali, Agrabad        
										C/A, Chittagong 4100, Bangladesh.
									</p>
                                    <p>Seagull has experience of ship repairer & supplies under various ship owners</p>
                                    <p>E-MAIL: <a href="#" style="border-bottom: solid 1px; border-color:blue;">kazi@seagullmarinebd.com</a> Contact: + 880-31-2526668 & + 880-31-726198 & + 880-31-721459</p>
