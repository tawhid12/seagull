...
@section('pageTitle','Upload Work Done certificate')
@section('pageSubTitle','Upload Work Done certificate')
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th colspan="8" class="text-center">
                                    <h5>Upload Work Done Report</h5>
                                </th>
                            </tr>
                            <tr>
                                <th colspan="8" class="text-center">
                                    <form class="form" method="post" enctype="multipart/form-data" action="{{route('work-done-report.store')}}">
                                        @csrf
                                        <input type="hidden" name="order_id" value="{{request()->get('id')}}">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="file" class="form-control" name="work_done_report">
                                                </div>
                                                @if($errors->has('work_done_report'))
                                                <span class="text-danger"> {{ $errors->first('work_done_report') }}</span>
                                                @endif
                                            </div>
