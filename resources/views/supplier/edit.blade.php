...
@section('pageSubTitle', 'Edit Supplier')
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data"
                                action="{{ route('supplier.update', encryptor('encrypt', $sup->id)) }}">
                                @csrf
                                @method('patch')
                                <input type="hidden" name="uptoken" value="{{ encryptor('encrypt', $sup->id) }}">
                                <div class="row">
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label for="name">Name</label>
                                            <input type="text" id="supplier_name" class="form-control"
                                                placeholder="Supplier Name" name="supplier_name" value="{{ $sup->supplier_name }}">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="phone" class="form-control"
                                                placeholder="Land Phone" name="phone" value="{{ $sup->phone }}">
                                        </div>
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="mobile" class="form-control"
                                                placeholder="Mobile No" name="mobile" value="{{ $sup->mobile }}">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" id="description" placeholder="description" name="description">{{ $sup->description }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" id="address" placeholder="Address" name="address">{{ $sup->address }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contact_person_name" class="form-control"
                                                placeholder="Contact Person Name" name="contact_person_name" value="{{ $sup->contact_person_name }}">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contact_person_phone" class="form-control"
                                                placeholder="Contact Person Phone" name="contact_person_phone" value="{{ $sup->contact_person_phone }}">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contact_person_email" class="form-control"
                                                placeholder="Contact Person Email" name="contact_person_email" value="{{ $sup->contact_person_email }}">
                                        </div>
