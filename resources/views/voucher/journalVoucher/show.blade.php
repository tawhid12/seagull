...
@section('pageTitle',trans('Show Journal Voucher'))
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <h1 class="d-none only_print text-center mb-3">Journal Voucher</h1>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="countryName">{{__('Voucher No')}}: </label> <span>{{$journalVoucher->voucher_no}}</span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="countryName">{{__('Date')}}: </label> <span>{{$journalVoucher->current_date}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="name">{{__('Name')}}: </label>{{$journalVoucher->pay_name}}
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="Purpose">{{__('Purpose')}}: </label> {{$journalVoucher->purpose}}
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group @if($errors->has('name')) has-error @endif">
                                            <label>{{__('Cheque No')}}: </label>{{$journalVoucher->cheque_no}}
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group">
                                        <label>{{__('Bank Name')}}: </label>{{$journalVoucher->bank}}
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group">
                                        <label>{{__('Cheque Date')}}: </label>{{$journalVoucher->cheque_dt}}
                                        </div>
                                    </div>
                                </div>
