            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" enctype="multipart/form-data" method="post" action="{{route('debit.update',encryptor('encrypt',$dvoucher->id))}}">
                                @csrf
                                @method('patch')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="order_id" class="form-control">
                                                ...
                                                @forelse($orders as $or)
                                                    <option value="{{$or->id}}" @if($dvoucher->order_id == $or->id) selected @endif>{{$or->order_subject}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
