                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="pro_type_id" class="form-control">
                                                ...
                                                @forelse($pro_types as $pt)
                                                    <option value="{{$pt->id}}">{{$pt->product_type_name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="product_item_code" class="form-control"
                                                   placeholder="Product Item Code" name="product_item_code">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="manufacturer" class="form-control"
                                                   placeholder="Product Manufacturer" name="manufacturer">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="product_model" class="form-control"
                                                   placeholder="Product Model" name="product_model">
                                        </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="manu_country" class="form-control"
                                                   placeholder="Manufacturer Country" name="manu_country">
                                        </div>
